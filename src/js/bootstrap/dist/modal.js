  ...
  const Modal = /* #__PURE__ */ (function () {
    ...
    _proto.show = function show(relatedTarget) {
      ...
      EventHandler__default.default.on(this._dialog, EVENT_MOUSEDOWN_DISMISS, () => {
        EventHandler__default.default.one(_this._element, EVENT_MOUSEUP_DISMISS, (
          event
        ) => {
    ...
    _proto.hide = function hide(event) {
      ...
      if (transition) {
        ...
        EventHandler__default.default.one(this._element, TRANSITION_END, (event) => {
    ...
    _proto._triggerBackdropTransition = function _triggerBackdropTransition() {
      ...
      if (this._config.backdrop === 'static') {
        ...
        EventHandler__default.default.one(this._element, TRANSITION_END, () => {
          ...
          if (!isModalOverflowing) {
            EventHandler__default.default.one(_this9._element, TRANSITION_END, () => {
    ...
    _proto._setScrollbar = function _setScrollbar() {
      ...
      if (this._isBodyOverflowing) {
        ...
        SelectorEngine__default.default.find(SELECTOR_FIXED_CONTENT).forEach((element) => {
    ...
    _proto._resetScrollbar = function _resetScrollbar() {
      ...
      SelectorEngine__default.default.find(SELECTOR_FIXED_CONTENT).forEach((element) => {
        const padding = Manipulator__default.default.getDataAttribute(element, 'padding-right');
      ...
      SelectorEngine__default.default
        .find(String(SELECTOR_STICKY_CONTENT))
        .forEach((element) => {
          const margin = Manipulator__default.default.getDataAttribute(element, 'margin-right');
      ...
      const padding = Manipulator__default.default.getDataAttribute(
        document.body,
        'padding-right'
      );
